// ISABELLE JAVA SCRIPT

var song = ["Older by Sasha Sloan", "Delicate by Taylor Swift", "Alaska by Maggie Rogers", "Love Song by Zak Abel", "Hundred by Khalid", "Hey Jude by The Beatles", "Dreams by Fleetwood Mac", "Thick and Thin by LANY", "Love It If We Made It by The 1975", "Vroom Vroom by Charli XCX", "all the good girls go to hell by Billie Eilish", "I Know A Place by MUNA", "Self Care by Emmalyn", "Holiday by The Aces", "Neon Moon (feat. Kacey Musgraves) by Brooks & Dunn", "Talia by King Princess", "Exhale by Sabrina Carpenter", "Rocket Man by Elton John", "Medicine by The 1975", "Supercut by Lorde", "Peach by Broods", "The Wire by HAIM", "Say It by Maggie Rogers", "Mothers Daughter by Miley Cyrus", "No Drug Like Me by Carly Rae Jepsen", "You Need to Calm Down by Taylor Swift", "Five in the Morning by Charli XCX"]
...
button.addEventListener ("click" , function (){
    ...
    document.querySelector("h2").innerHTML = (song[Math.floor(Math.random() * 27)]);
});
